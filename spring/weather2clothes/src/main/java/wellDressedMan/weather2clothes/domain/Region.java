...
public class Region {
    ...
    private int midLandCode;
    private int midTempCode;
//    @Embedded
//    private WeatherResponse weatherResponse; // 지역 날씨 정보

    // 날씨 정보 제외하고 지역 생성
    public Region(Long id, String parentRegion, String childRegion, int nx, int ny, int midLandCode, int midTempCode) {
        this.id = id;

...
main(void)
{
  ...
  ab:	68 6c 08 00 00       	push   $0x86c
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 6f 08 00 00       	push   $0x86f
  bc:	6a 01                	push   $0x1
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 3e 08 00 00       	push   $0x83e
  d2:	e8 b3 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 3e 08 00 00       	push   $0x83e
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 8e 08 00 00       	mov    $0x88e,%ebx
        while(*s != 0){
 ...
 6b1:	a1 48 0b 00 00       	mov    0xb48,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 48 0b 00 00       	mov    %eax,0xb48
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 48 0b 00 00    	mov    0xb48,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 48 0b 00 00    	cmp    %eax,0xb48
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 48 0b 00 00    	mov    0xb48,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 48 0b 00 00 4c 	movl   $0xb4c,0xb48
 807:	0b 00 00 
 80a:	c7 05 4c 0b 00 00 4c 	movl   $0xb4c,0xb4c
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 4c 0b 00 00       	mov    $0xb4c,%eax
 819:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 820:	00 00 00 
